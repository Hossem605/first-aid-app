[package.json](https://github.com/user-attachments/files/22187950/package.json)
{
  "name": "first-aid-app",
  "version": "0.1.0",
  "private": true,
...
[package-lock.json](https://github.com/user-attachments/files/22187951/package-lock.json)
{
  "name": "first-aid-app",
  "version": "0.1.0",
  "lockfileVersion": 3,
...
[tsconfig.json](https://github.com/user-attachments/files/22187953/tsconfig.json)
{
  "compilerOptions": {
    "target": "es5",
    "lib": [
...
[tailwind.config.js](https://github.com/user-attachments/files/22187954/tailwind.config.js)
...
[postcss.config.js](https://github.com/user-attachments/files/22187955/postcss.config.js)
module.exports = {
  plugins: {
    tailwindcss: {},
    autoprefixer: {},
